...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "normal_mapping", NULL, NULL);
	if (window == NULL)
	{
	...
	Shader shader("normal_mapping_vShader.glsl", "normal_mapping_fShader.glsl");
...
void RenderQuad()
{
	if (quadVAO == 0)
	{
		...
		//std::cout << bitangent1.x<< bitangent1.y<< bitangent1.z	;
